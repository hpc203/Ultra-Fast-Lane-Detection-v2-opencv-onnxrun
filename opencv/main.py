...
if __name__=='__main__':
    ...
    parser.add_argument("--imgpath", type=str, default='images/culane/00000.jpg', help="image path")
    parser.add_argument("--modelpath", type=str, default='weights/ufldv2_culane_res18_320x1600.onnx', help="onnx modelpath")
